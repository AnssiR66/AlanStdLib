...
- [`/tutoria[utf8/] (_ignored folder_) — UTF-8 converted Alan files (`*.alan`, `*.i`, `*.a3sol`, `*.a3log`).
- [`update.sh`](update.sh) — build script to update contents of "`../extras/`". (Depends on various scripts from [`../assets/sh/`][assets/sh/])
