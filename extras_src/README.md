...
3. __Format Transcipts to AsciiDoc__ — Run every `.a3log` file generated by the previous step through a SED script that will convert the verbatim transcript into a well-formatted AsciiDoc example block:
