...
*                                                                              *
*                       PART Library Classes » Locations                       *
*                                                                              *
********************************************************************************
////
...
[source,alan]
------------------------------------------------------
include::./_locations_no-lib.alan[encoding=iso-8859-1]
------------------------------------------------------
...
[source,alan]
----------------------------------------------------------------------------------------
include::./_custom-room-site-instances.alan[encoding=iso-8859-1,tag=room-site-instances]
----------------------------------------------------------------------------------------
...
[source,alan]
--------------------------------------------------
include::./livingroom.alan[encoding=iso-8859-1,tag=livingroom]
--------------------------------------------------
...
===============================================================
include::./livingroom.a3log[encoding=iso-8859-1,tag=livingroom]
===============================================================
...
[source,alan]
------------------------------------------------
include::./livingroom.alan[encoding=iso-8859-1,tag=trapdoor]
------------------------------------------------


[example,role="gametranscript"]
=============================================================
include::./livingroom.a3log[encoding=iso-8859-1,tag=trapdoor]
=============================================================
...
[source,alan]
---------------------------------------------------------------
include::./meadow.alan[encoding=iso-8859-1,tag=outdoor-example]
---------------------------------------------------------------
...
[source,alan]
------------------------------------------------------------
include::./meadow.alan[encoding=iso-8859-1,tag=change-descs]
------------------------------------------------------------


[example,role="gametranscript"]
=============================================================
include::./meadow.a3log[encoding=iso-8859-1,tag=change-descs]
=============================================================
...
In order to be lit, a `DARK_LOCATION` requires the presence of a `lit` `lightsource` object (e.g. a candle, a torch, whatever).
...
.Dark Places Cheat Sheet
********************************************************************************
Here are some simple guidelines on which approach to chose for implementing dark locations:

* If you need a location that can only be illuminated via some fixed mechanism (a switch, a timer, etc.), and won't be affected by light source objects, then use the base `location` class (or `ROOM`/`SITE`) and implement some method to toggle the state of its `lit` attribute.

* If you need a location that can only be illuminated by the presence of lit light source objects (e.g. a cave), then use the `DARK_LOCATION` class (or `DARK_ROOM`/`DARK_SITE`).

* If you need an hybrid approach, where besides using light source objects there's also a mechanism to render the location permanently lit (e.g. to implement a day and night cycle, where light sources are required only during the night), then use `DARK_LOCATION` in conjunction with the `forced_lit` attribute (see the <<example.forced_lit,_forest_ example>>).
********************************************************************************
...
[source,alan]
--------------------------------------------------------
include::./basement.alan[encoding=iso-8859-1,tag=unlit-room-example]
--------------------------------------------------------
...
[source,alan]
--------------------------------------------------------------------
include::./basement.alan[encoding=iso-8859-1,tag=unlit-room-example-lightsource]
--------------------------------------------------------------------
...
[example,role="gametranscript"]
=======================================================================
include::./basement.a3log[encoding=iso-8859-1,tag=unlit-room-example-1]
=======================================================================
...
[example,role="gametranscript"]
=======================================================================
include::./basement.a3log[encoding=iso-8859-1,tag=unlit-room-example-2]
=======================================================================
...
[example,role="gametranscript"]
=======================================================================
include::./basement.a3log[encoding=iso-8859-1,tag=unlit-room-example-3]
=======================================================================
...
[source,alan]
---------------------------------------------------------
include::./sewers.alan[encoding=iso-8859-1,tag=dark-location-example]
---------------------------------------------------------
...
[example,role="gametranscript"]
=======================================================================
include::./sewers.a3log[encoding=iso-8859-1,tag=dark-location-example1]
=======================================================================
...
[example,role="gametranscript"]
=======================================================================
include::./sewers.a3log[encoding=iso-8859-1,tag=dark-location-example2]
=======================================================================
...
[example,role="gametranscript"]
=======================================================================
include::./sewers.a3log[encoding=iso-8859-1,tag=dark-location-example3]
=======================================================================
...
[example,role="gametranscript"]
=======================================================================
include::./sewers.a3log[encoding=iso-8859-1,tag=dark-location-example4]
=======================================================================
...
[source,alan]
------------------------------------------------------
include::./forest.alan[encoding=iso-8859-1,tag=forced-lit-example]
------------------------------------------------------
...
[example,role="gametranscript"]
====================================================================
include::./forest.a3log[encoding=iso-8859-1,tag=forced-lit-example1]
====================================================================


=== Dual Location Approach

In Alan you cannot change the name of a location mid-game.
Therefore, if you name a dark location '`Darkness`' and wish to make it lit at some point in the game, its name will still remain '`Darkness`'.
To show a change in the location name, you must locate the hero in another location when the dark location is lit.
For example,


// @EXTERNALIZE CODE: treasure_chamber 1
[source,alan]
--------------------------------------------------------------------------------
...
// @EXTERNALIZE CODE: treasure_chamber 2
[source,alan]
--------------------------------------------------------------------------------
When lantern is lit
...
This trick will work with both unlit locations and `DARK_LOCATION` instances.
...
[WARNING]
=====================================
This section needs some introductory text!
=====================================
