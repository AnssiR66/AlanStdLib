...
*                                                                              *
*                    PART Library Classes » Special Objects                    *
*                                                                              *
********************************************************************************
////
...
The Standard Library defines some specialized classes to implement special game objects:
...
[source,alan]
--------------------------------------------
include::./wedding.alan[encoding=iso-8859-1,tag=tuxedos]
--------------------------------------------
...
=========================================================
include::./wedding.a3log[encoding=iso-8859-1,tag=tuxedos]
=========================================================
...
.Example: Basic device implementation (from {lab1_alan})
[source,alan]
----------------------------------------------
include::./lab1.alan[encoding=iso-8859-1,tag=thingummyjig]
----------------------------------------------
...
[example,role="gametranscript"]
===========================================================
include::./lab1.a3log[encoding=iso-8859-1,tag=thingummyjig]
===========================================================
...
.Example: Custom device description (from {lab2_alan})
[source,alan]
----------------------------------------------
include::./lab2.alan[encoding=iso-8859-1,tag=thingummyjig]
----------------------------------------------
...
[example,role="gametranscript"]
===========================================================
include::./lab2.a3log[encoding=iso-8859-1,tag=thingummyjig]
===========================================================
...
.Example: Basic door implementation (from {garden1_alan})
[source,alan]
-----------------------------------------------
include::./garden1.alan[encoding=iso-8859-1,tag=front_door]
-----------------------------------------------
...
[example,role="gametranscript"]
============================================================
include::./garden1.a3log[encoding=iso-8859-1,tag=front_door]
============================================================
...
.Example: Custom door description (from {garden2_alan})
[source,alan]
-----------------------------------------------
include::./garden2.alan[encoding=iso-8859-1,tag=front_door]
-----------------------------------------------
...
[example,role="gametranscript"]
============================================================
include::./garden2.a3log[encoding=iso-8859-1,tag=front_door]
============================================================
...
See also <<app.short-examples>>, <<sec.short-example.5,example 5>>.
...
A LIGHTSOURCE can be either `natural` or `NOT natural`, and will accept different verbs to interact with it, depending on the type:


* [.red]#*Natural light sources*# (e.g. a match, a candle, a campire) can be lighted and extinguished/put out, if `NOT broken`. +
But they can't be turned/switched on/off.

* [.red]#*Artificial light sources*# (e.g. a flashlight, a table lamp) can be turned/switched on/off and lighted, if `NOT broken`. +
But they can't be extinguished/put out.

// @TODO: Should mention if lightsources are also mentioned as lit/unlit in the
//        course of normal descriptions (e.g. location description, or when
//        listing items inside containers or on top of supporters, etc.).
//        Is it so? (need to test this)

When a `lightsource` instance is examined, the library will additionally mention whether it's providing light or not.

The default attributes for a LIGHTSOURCE object are: `natural`, `NOT lit`.

// 'torch' -> LIGHTSOURCE (LIT) AT cave:

.Example: Implementing a natural light source (from {cave_alan})
[source,alan]
---------------------------------------------------------------
include::./cave.alan[encoding=iso-8859-1,tag=lightsource_torch]
---------------------------------------------------------------

// 'lamp' -> LIGHTSOURCE (NOT natural) AT lab:

.Example: Implementing an artificial light source (from {lab1_alan})
[source,alan]
--------------------------------------------------------------
include::./lab1.alan[encoding=iso-8859-1,tag=lightsource_lamp]
--------------------------------------------------------------
...
[example,role="gametranscript"]
================================================================
include::./cave.a3log[encoding=iso-8859-1,tag=lightsource_torch]
================================================================
...
[example,role="gametranscript"]
===============================================================
include::./lab1.a3log[encoding=iso-8859-1,tag=lightsource_lamp]
===============================================================
...
.Example: Customizing the examine response of light sources (from {lab2_alan})
[source,alan]
--------------------------------------------------------------
include::./lab2.alan[encoding=iso-8859-1,tag=lightsource_lamp]
--------------------------------------------------------------
...
[example,role="gametranscript"]
===============================================================
include::./lab2.a3log[encoding=iso-8859-1,tag=lightsource_lamp]
===============================================================
...
[WARNING]
=====================================
@FIXME: this sentence in incomplete -- "even if ... What?"
=====================================
