...
:newgame_alan: pass:q,a[link:{StdLibDir}/newgame.alan[`newgame.alan`^,title="Open adventure template"]]
:testgame_alan: pass:q,a[link:{StdLibDir}/testgame.alan[`testgame.alan`^,title="Open source adventure"]]
:mygame_import: pass:q,a[link:{StdLibDir}/mygame_import.i[`mygame_import.i`^,title="Open source file"]]
// :XXXX: pass:q,a[YYYY]
