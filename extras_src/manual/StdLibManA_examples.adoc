...
.Short Example #1: {short_example1_alan}
[source,alan]
-------------------------------------------------------------
include::./short-example1.alan[encoding=iso-8859-1,tag=shown]
-------------------------------------------------------------

This game wouldn't actually need the library at all; it would be even shorter to code:

.Short Example #1, without StdLib: {short_example1_nolib_alan}
[source,alan]
--------------------------------------------------------------------
include::./short-example1_no-lib.alan[encoding=iso-8859-1,tag=shown]
--------------------------------------------------------------------
...
.Short Example #2: {short_example2_alan}
[source,alan]
-------------------------------------------------------------
include::./short-example2.alan[encoding=iso-8859-1,tag=shown]
-------------------------------------------------------------
...
In this example of defining the `my_game` instance, the author has changed the default verb responses for `eat`, `climb` and `take`.
In addition, the author has added a check and a response of his/her own to `take`:

[source,alan]
--------------------------------------------------------------
include::./_short-example3.alan[encoding=iso-8859-1,tag=shown]
--------------------------------------------------------------
...
[source,alan]
--------------------------------------------------------------
include::./_short-example4.alan[encoding=iso-8859-1,tag=shown]
--------------------------------------------------------------
...
[source,alan]
--------------------------------------------------------------
include::./_short-example5.alan[encoding=iso-8859-1,tag=shown]
--------------------------------------------------------------
...
.Short Example #6: {short_example6_alan}
[source,alan]
-------------------------------------------------------------
include::./short-example6.alan[encoding=iso-8859-1,tag=shown]
-------------------------------------------------------------
