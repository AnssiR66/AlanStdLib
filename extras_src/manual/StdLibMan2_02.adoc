...
=================================================
+
TIP: This default message can be changed by redefining the `dark_loc_desc` attribute on the `my_game` instance.
...
===============================
+
TIP: This default message can be changed by redefining the `check_current_loc_lit` attribute on the `my_game` instance.
...
2. The location is `NOT forced_lit`.
...
===============================
+
TIP: This default message can be changed by redefining the `light_goes_off` attribute on the `my_game` instance.
...
==== {asterisk}{asterisk}{asterisk} UNLIT LOCATION: BASEMENT EXAMPLE {asterisk}{asterisk}{asterisk}
