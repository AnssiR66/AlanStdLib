...
In this chapter you'll learn how to integrate the Standard Library into your ALAN adentures, how to set up your working environment, and other useful notions as a beginner to the library.


[[sec.importing-stdlib]]
