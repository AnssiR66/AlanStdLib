...
If the author doesn't change these default values, the default description, at will be "`You notice nothing unusual about the [object].`"
(Naturally, these commands won't work in outdoor locations.)
...
================================================================================
include::{utf8dir}/_variations1.a3ADocLog[tag=livingroom]
================================================================================
