...
:adv-transc1: clothing-01-simple__play1.a3t
:adv-transc2: clothing-01-simple__play2.a3t
...
-------------------------------------------------------
include::{adv-source}[encoding=iso-8859-1,tag=step_one]
-------------------------------------------------------
...
[source,alan,role=tutorial]
------------------------------------------------------
include::{adv-source}[encoding=iso-8859-1,tag=uniform]
------------------------------------------------------
...
[source,alan,role=tutorial]
-----------------------------------------------------
include::{adv-source}[encoding=iso-8859-1,tag=shower]
-----------------------------------------------------
...
-----------------------------------------------------------
include::{adv-source}[encoding=iso-8859-1,tag=shower_check]
-----------------------------------------------------------
...
=============================================
include::./{adv-transc1}[encoding=iso-8859-1]
=============================================

////
*VERBATIM TRANSCRIPT* -- We could also include the unsanitized version of the game transcript, in case it relied on monospace fonts (eg. debgugging):

.............................................................
include::./clothing-01-simple__play1.a3t[encoding=iso-8859-1]
.............................................................
...
[source,alan,role=tutorial]
-----------------------------------------------------------
include::{adv-source}[encoding=iso-8859-1,tag=bedroom_exit]
-----------------------------------------------------------
...
[source,alan,role=tutorial,indent=0]
---------------------------------------------------------
include::{adv-source}[encoding=iso-8859-1,tag=exit_check]
---------------------------------------------------------
...
[example,role="gametranscript"]
=============================================
include::./{adv-transc2}[encoding=iso-8859-1]
=============================================
...
The next step is about deciding how to asign the various layers to clothes types; the number of layers involved depends on which clothes we're going to create in the actual game.
The best approach is to do some initial brainstorming on the various types of clothes that we'd like to use.


* *Underwear* -- Garnments in direct contact with the skin (socks, underpants, vest).
* *Outer clothing* -- The first layer of outer garnments when the person is dressed (trousers, shirt, shoes, hat).
